...
export ZSH=/Users/bscharf/dotfiles/macos/oh-my-zsh
...
HEROKU_AC_ZSH_SETUP_PATH=/Users/bscharf/Library/Caches/heroku/autocomplete/zsh_setup && test -f $HEROKU_AC_ZSH_SETUP_PATH && source $HEROKU_AC_ZSH_SETUP_PATH;
...
if [ $? -eq 0 ]; then
    ...
    if [ -f "/miniconda3/etc/profile.d/conda.sh" ]; then
        ...
        \export PATH="/miniconda3/envs/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda init <<<
